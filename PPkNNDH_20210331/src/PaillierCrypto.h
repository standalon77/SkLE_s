...
//	paillier_ciphertext_t cCnt;					 						// (SkLE_s) total cnt
	...
	paillier_ciphertext_t cS[THREAD1_NUM]; 							// (SkLE_s) thread cnt
	paillier_ciphertext_t cTotal_S;					 					// (SkLE_s) total cnt
...
//	int Comparison(paillier_ciphertext_t* cGamma, paillier_ciphertext_t* cTotal_S, 							  pre_t *tPre, unsigned short idx, thp_t* tRecv, th_t* tSend, unsigned char* ucSendPtr);
